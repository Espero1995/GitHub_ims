<template>
	<div id="waitingList" class="webs">
		<div class="slotHeader">待处理工单</div>
		<div class="slotOptions">
			<div class="inputs">
				<span>工单状态: </span>
				<el-select v-model="search.dealStatus" placeholder="请选择">
					<el-option v-for="key in Object.keys($v.processState)" :key="key" :label="$v.processState[key]" :value="key"> </el-option>
				</el-select>
			</div>
			<div class="buttons">
